...
public class BitmapFontAlignmentTest extends GdxTest {
	...
	public void create (Application app) {
		...
		font = new BitmapFont(app.getFiles().getFileHandle("data/verdana39.fnt", FileType.Internal),
			app.getFiles().getFileHandle("data/verdana39.png", FileType.Internal), false);
